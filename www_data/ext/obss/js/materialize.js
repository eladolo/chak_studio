    ...
    function(a) {
        a.fn.tooltip = function(c) {
            ...
            return "remove" === c ? (this.each(function() {
                ...
                var g, h, i, j, k, l, ou, m = function() {
                    g = f.attr("data-html") ? "true" === f.attr("data-html") : c.html, h = f.attr("data-delay"), h = void 0 === h || "" === h ? c.delay : h, ou = void 0 === ou || "" === ou ? c.out : ou, i = f.attr("data-position"), i = void 0 === i || "" === i ? c.position : i, j = f.attr("data-tooltip"), j = void 0 === j || "" === j ? c.tooltip : j
                };
                m();
                var n = function() {
