window.pupface = (function() {
    ...
    var buildButtons = function() {
        ...
        $.each(alerts, function(index, val) {
            ...
            var tmp_button = "<img class='btnSend circle responsive tooltiped' data-tooltip='" + bits_val[Number(alerts[index].bits) - 1] + " bits' style='width: 64px; height: 64px; cursor: pointer;' data-index='" + index + "' src='" + tmp_img + "' />";
