...
window.pupface = (function() {
    ...
    var _init = function() {
        ...
        $('.btnTest').addClass('on').addClass('cursor').removeClass('hide').off('click').on('click', function() {
            ...
            alerts_tmp[tmp_index - 1].img_url = ($("#tier" + tmp_index + "_img").val() === "" || $("#tier" + tmp_index + "_img").val() == "none" ? '' : $("#tier" + tmp_index + "_img").val());
            alerts_tmp[tmp_index - 1].body = decodeURI($("#tier" + tmp_index + "_body").val());
            ...
            alerts_tmp[tmp_index - 1].iconres = decodeURI($("#tier" + tmp_index + "_iconres").val());
            alerts_tmp[tmp_index - 1].font = $("#tier" + tmp_index + "_font").val();
            alerts_tmp[tmp_index - 1].font_color = $("#tier" + tmp_index + "_font_color").val();
            alerts_tmp[tmp_index - 1].glow_light = $("#tier" + tmp_index + "_glow_light").val();
            alerts_tmp[tmp_index - 1].glow_hard = $("#tier" + tmp_index + "_glow_hard").val();
            ...
            alerts_tmp[tmp_index - 1].audio_url = $("#tier" + tmp_index + "_audio_url").val();
        ...
        $('.btnSave').addClass('on').addClass('cursor').removeClass('hide').off('click').on('click', function() {
            ...
            for (var i = 0; i < alerts.length; i++) {
                ...
                tmp_config["tier" + (i + 1) + "_iconres"] = encodeURI($("#tier" + (i + 1) + "_iconres").val());
                tmp_config["tier" + (i + 1) + "_font"] = $("#tier" + (i + 1) + "_font").val();
                tmp_config["tier" + (i + 1) + "_font_color"] = $("#tier" + (i + 1) + "_font_color").val();
