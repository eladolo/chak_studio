<?php
    ...
    class DB{
    	public $host = DB_host;
    	public $name = DB_name_4;
    	public $user = DB_user_4;
    	public $password = DB_password_4;
    ...
    class DBW{
        ...
        public $name = DB_name_4_WR;
        public $user = DB_user_4_WR;
        public $password = DB_password_4_WR;
    ...
    class API{
        ...
        */
        ...
        private function signJWT($payload_array){
            ...
            $signature = hash_hmac('sha256', $base64UrlHeader . "." . $base64UrlPayload, $this->base64UrlDecode(SECRET_SHARE_4), true);
        ...
        private function verifyJWT($jwt){
            ...
            $rawSignature = hash_hmac('sha256', $dataEncoded, $this->base64UrlDecode(SECRET_SHARE_4), true);
